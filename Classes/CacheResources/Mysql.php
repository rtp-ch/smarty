 ...
 * @author Rodney Rehm
 */
class Tx_Smarty_CacheResources_Mysql extends Smarty_CacheResource_Custom
{
    /**
     * @var Name of the cache to use
     */
    const CACHE_NAME = 'cache_mysql_smarty';
            ...
            try {
                ...
                $GLOBALS['typo3CacheFactory']->create(
                    ...
                    array(
                        ...
                        'cacheTable' => 'cachingframework_cache_smarty',
                        'tagsTable' => 'cachingframework_cache_smarty_tags',
                    )
                );
