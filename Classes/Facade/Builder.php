...
t3lib_div::debug(array(
    '$this' => get_object_vars($this)
        ...
        if(Tx_Smarty_Utility_Typo3::isFeInstance()) {
            $smartyInstance->setContentObject($GLOBALS['TSFE']->cObj);

        // Attempts to simulate the frontend environment when in the backend
     ...
     */
    private function simulateFrontendEnvironment()
    {
     ...
     */
    private function resetFrontendEnvironment()
    {
        $GLOBALS['TSFE'] = $this->tsfeBackup;
    }


    // TODO: get and set content object, ditto parent object
